...
class CascadeRCNN(chainer.Chain):
    ...
    stride = 32
    _acceptable_return_values = ('rois', 'bboxes', 'labels', 'scores')

    def __init__(self, extractor, rpn, bbox_heads, return_values,
        ...
        self._run_bbox = bool(
            set(self._return_values) & {'bboxes', 'labels', 'scores'})
